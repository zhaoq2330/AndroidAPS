...
class ActionsFragment : DaggerFragment() {
    ...
    fun updateGui() {
        ...
        binding.fill.visibility = (pump.pumpDescription.isRefillingCapable && pump.isInitialized() && loop.runningMode != RM.Mode.DISCONNECTED_PUMP && !pump.isSuspended()).toVisibility()
